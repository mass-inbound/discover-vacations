...
const faqs = [
  ...
  // Repeat 7 times for demo
  {
    ...
    answer: (
      <>
        ...
        <p className="mt-2">
          You'll receive a link via email/SMS to the My Discover Booking Portal.
  ...
  {
    question: 'How do I access the My Discover Booking Portal after purchase?',
    summary:
      "Once your purchase is complete, you'll receive a link via email or SMS to access the My Discover Booking Portal. Enter your email and Package ID to log in. Or visit...",
    answer: (
      <>
        Once your purchase is complete, you'll receive a link via email or SMS
        to access the My Discover Booking Portal. Enter your email and Package
        ID to log in.
        <br />
        Or visit{' '}
        <a

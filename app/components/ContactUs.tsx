            ...
            <div>
              ...
              <div className="flex items-start gap-2 mt-2">
                ...
                >
                  ...
                  messaging rates may apply. Please read our <a href='/' style={{textDecoration:"underline"}}>Terms &
                  Conditions</a> and <a href='/' style={{textDecoration:"underline"}}>Privacy Policy</a>.
                </label>
              </div>
            </div>
            <button

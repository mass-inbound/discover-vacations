        ...
        {(footer) => (
          <footer className="bg-[#0E424E] text-white pt-12 pb-4">
            ...
            <div className="border-t border-white/20 mt-10 mb-10 sm:mb-0 pt-4 md:pb-6 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-4 text-xs opacity-80">
              <span>©2024 My Discover Vacations. All rights reserved <br> THIS ADVERTISING MATERIAL IS BEING USED FOR THE PURPOSE OF SOLICITING SALES OF TIMESHARE INTERESTS OR PLANS </br></span>
